...
execute_process(COMMAND perl ${base}/../src/filter/drawgate-ppm.pl INPUT_FILE ${out}.base OUTPUT_FILE ${name}.ppm)
execute_process(COMMAND perl ${base}/../src/filter/drawgate-txt.pl INPUT_FILE ${out}.base OUTPUT_FILE ${out}.text)
